  ...
  const projects = [
    {
      name: 'Myuze Play',
      description:
        'An audiobook and original audio-shows platform delivering curated content in 30 minutes or less—perfect for busy listeners who crave quick, insightful listening experiences',
      imageUrl: assets.myuze,
      androidUrl:
        'https://play.google.com/store/apps/details?id=com.myuze.play',
      iosUrl:
        'https://apps.apple.com/in/app/myuzeplay-audio-books-shows/id6593696695',
      webUrl: 'https://myuzeplay.com',
    },
    {
      name: 'Trucksup',
      description:
        'A logistics platform powering AI-driven truck booking, real-time tracking, and verified load matching—focused on simplifying operations for drivers and businesses across India',
      imageUrl: assets.trucksup,
      androidUrl:
        'https://play.google.com/store/apps/details?id=com.logistics.trucksup',
    },
    {
      name: 'Islamic Urdu Calendar',
      description:
        'A culturally tailored calendar app offering prayer times, festival dates, and Islamic event reminders in Urdu—designed for everyday convenience in regional contexts.',
      imageUrl: assets.urdu,
      androidUrl:
        'https://play.google.com/store/apps/details?id=sjaveed.Islamic.indiaCalendar',
    },
    {
      name: 'Log-x view',
      description:
        'A mobile and web solution that enables solar plant owners to remotely monitor energy generation and performance—built with seamless data visualization and alerts.',
      imageUrl: assets.logx,
      androidUrl:
        'https://play.google.com/store/apps/details?id=com.injectsolar',
      iosUrl: 'https://apps.apple.com/in/app/logx-view/id1462429858',
      webUrl: 'https://injectsolar.com',
    },
    {
      name: 'Lystn',
      description:
        'An audio‑storytelling app offering localized and curated audio narratives—connecting listeners with engaging content on the go.',
      imageUrl: assets.lystn,
      androidUrl:
        'https://play.google.com/store/apps/details?id=com.app.lystn',
      iosUrl:
        'https://apps.apple.com/pk/app/lystn-audiostories/id1586146781',
    },
    {
      name: 'Walkie Talkie',
      description:
        'A push-to-talk app enabling instant voice communication—ideal for teams needing real-time coordination without traditional walkie‑talkie hardware.',
      imageUrl: assets.walkie,
      androidUrl:
        'https://play.google.com/store/apps/details?id=network.talker.app',
      iosUrl:
        'https://apps.apple.com/us/app/talker-ptt-walkie-talkie/id1597656037',
    },
    {
      name: 'Guru Deals',
      description:
        'A deals aggregator app that collects and displays local discounts and coupon offers—offering users a convenient way to save on everyday purchases.',
      imageUrl: assets.guruDeals,
      androidUrl:
        'https://play.google.com/store/apps/details?id=com.user.gurudeals',
    },
    {
      name: 'CargoPro (formerly Liveasy)',
      description:
        'A freight and logistics platform that helps businesses book transport, track shipments, and manage loads efficiently—designed for seamless supply chain operations.',
      imageUrl: assets.cargopro,
      androidUrl:
    ...
    },
    {
      name: 'Telugu Panchangam Calendar2025',
      description:
        'A regional calendar app providing Telugu daily panchang (almanac) details, festivals, and muhurtham times—geared toward cultural planning and observances.',
      imageUrl: assets.telugu,
      androidUrl:
        'https://play.google.com/store/apps/details?id=vikramnextgenapps.telugu.calendar',
    },
    {
      name: 'Alonkar Fashion',
      description:
        'A cross-platform shopping app featuring local products, in-app purchases, and e-commerce features—crafted for a seamless mobile shopping experience.',
      imageUrl: assets.alonkar,
      androidUrl:
        'https://play.google.com/store/apps/details?id=com.alonkar.shopping',
      iosUrl:
        'https://apps.apple.com/in/app/alonkar-shopping/id6746260800',
    },
  ];
  ...
  return (
    <div className="relative w-full py-16 bg-[#0d1117] overflow-hidden">
      <div
        ...
        onMouseEnter={stopAutoScroll}
        onMouseLeave={startAutoScroll}
        className="flex flex-nowrap overflow-x-scroll space-x-6 px-4 scroll-smooth no-scrollbar"
      >
        {[...projects, ...projects].map((project, index) => (
          <div
            key={index}
            onMouseEnter={() => setHoveredIndex(index)}
            onMouseLeave={() => setHoveredIndex(null)}
            className="w-[18rem] sm:w-80 flex-shrink-0 bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl shadow-lg overflow-hidden transition-all duration-300 hover:scale-[1.03]"
          >
            <img
              src={project.imageUrl}
              alt={project.name}
